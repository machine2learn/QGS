...
QGS is a computer program to create genetic variables from SNP data. For every individual, it calcuates the genetic distance to a reference population. QGS works with both VCF or PLINK format data.
