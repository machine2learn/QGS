...
bool pass_gene_filter(Genblock const & gb, std::unordered_map<std::string, std::string> const & gtf_filter) {
...
bool operator<(Genblock const & gb, SNPreader::Locus const & l) {
